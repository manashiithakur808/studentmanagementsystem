...
@section('body-class', 'register-page d-flex align-items-center justify-content-center min-vh-100')

@push('styles')
<style>
    body.register-page {
        background: linear-gradient(135deg, #0fd850 0%, #00b4d8 50%, #0077b6 100%);
    }
    .glass-card {
        ...
        <div class="col-12 col-sm-9 col-md-7 col-lg-5">
            ...
            <div class="glass-card p-4 p-md-5">
                ...
                <div class="text-center mb-4">
                    ...
                    <h2 class="fw-bold mt-2 fs-3">Create Account</h2>
                    <p class="opacity-75 mb-0">Join us today — it's free!</p>
                </div>
